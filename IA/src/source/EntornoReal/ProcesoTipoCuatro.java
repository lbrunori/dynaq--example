 ...
 */
public class ProcesoTipoCuatro extends Proceso{
    //valores de la clase obtenidos de la tabla que se utilizan para
    //calcular los valores con las distrubiciones
    private static double velocidadMediaInicialArriba = 0.35;
    private static double tiempoMedioProcesamiento = 4;
    private static String nombreDelProceso = "T4";

    private static int beneficio = 30;
    ...
    public ProcesoTipoCuatro() {
        //reemplazar con un valor dado por la distribucion de poisson
        this.tiempoArribo = new BigDecimal(this.getPoisson(ProcesoTipoCuatro.velocidadMediaInicialArriba));
        //reemplazar con un valor dado por la distribucion exponencial
        this.tiempoProcesamientoRestante = new BigDecimal( this.getExponencial(ProcesoTipoCuatro.tiempoMedioProcesamiento));
    }
